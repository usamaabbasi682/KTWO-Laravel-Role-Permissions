...
@if (!empty($header_image))
	@php
		$headerImg = asset('storage/'.$header_image->id.'/'.$header_image->file_name);
	@endphp
@else
	@php
		$headerImg = null;
	@endphp
@endif
<div class="header-top d-flex align-items-stretch flex-grow-1 header_image" style="background-image: url({{ $headerImg ?? '' }});">
	<!--begin::Container-->
