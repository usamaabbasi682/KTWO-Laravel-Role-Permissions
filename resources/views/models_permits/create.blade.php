                        ...
                        <div class="notice d-flex bg-light-danger rounded border-danger border border-dashed mb-9 p-6">
                            ...
                            <div class="d-flex flex-stack flex-grow-1">
                                ...
                                <div class="fw-semibold">
                                    ...
                                    <strong class="me-1">Warning!</strong>While creating a model You can only define your model with one word. For Example, if you are making permissions for <b>users</b> your model name should be <b>user</b> similarly for <b>roles</b> model name should be <b>role</b>...</div>
                                </div>
                                <!--end::Content-->
                            </div>
                            <!--end::Wrapper-->
